...
class GendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gender" do
    assert_difference("Gender.count") do
      post genders_url, params: { gender: { gendername: @gender.gendername, image: @gender.image } }, as: :json
    end
  ...
  test "should update gender" do
    patch gender_url(@gender), params: { gender: { gendername: @gender.gendername, image: @gender.image } }, as: :json
    assert_response :success
  end
